...
def get_args():
    ...
    # for recursive nn definition
    parser.add_argument('--recursive-nn-def', type=str, default='recursive_nn.yaml')
    parser.add_argument('--mjcf-root-node', type=str, default='torso')
